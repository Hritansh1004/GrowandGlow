...
import type { RoomRoutinePeriod } from "../hooks/useStudyRooms";
import {
  ArrowLeftIcon,
  SendIcon,
  CopyIcon,
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                {roomMembers
                  ...
                  .map((member) => {
                    ...
                    const label = member.profile?.display_name || "Benchmate";
              ...
              {messages.length === 0 ? (
                ...
                messages.map((m) => {
                  ...
                  return (
                    ...
                    >
                      {!isMe && (
                        <p style={{ margin: "0 0 3px", fontSize: "11px", color: colors.accent, fontWeight: 800 }}>
